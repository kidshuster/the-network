...
class PersistentViewRegistry:
    ...
    def register_join_network_view(self) -> discord.ui.View:
        from bot.features.widgets.views.join_views import JoinNetworkView
    ...
    def register_moderator_review_view(self, request_id: int) -> discord.ui.View:
        from bot.features.widgets.views.join_views import ModeratorReviewView
    ...
    def register_subscribe_setup_view(
        ...
        from bot.features.widgets.views.network_views import SubscribeSetupView
    ...
    def register_subscription_moderation_view(
        ...
        from bot.features.widgets.views.network_views import SubscriptionModerationView
