...
from bot.widgets.views._auth import MembershipPolicy, ensure_client_access
...
class NetworkProfileView(discord.ui.View):
    ...
    async def _edit_callback(self, interaction: discord.Interaction) -> None:
        from bot.widgets.views.profile_views import EditClientProfileModal
    ...
    async def _delete_callback(self, interaction: discord.Interaction) -> None:
        ...
        from bot.widgets.views.profile_views import DeleteClientConfirmView
