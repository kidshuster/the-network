...
from bot.core.widgets import render_embed, render_text
from bot.core.widgets.views._auth import MembershipPolicy, ensure_client_access
from bot.core.widgets.views._view_helpers import bind_item_callback
from bot.core.widgets.views.custom_ids import (
    blacklist_button,
...
class NetworkProfileView(discord.ui.View):
    ...
    async def _edit_callback(self, interaction: discord.Interaction) -> None:
        from bot.core.widgets.views.profile_views import EditClientProfileModal
    ...
    async def _delete_callback(self, interaction: discord.Interaction) -> None:
        ...
        from bot.core.widgets.views.profile_views import DeleteClientConfirmView
