...
from bot.core.widgets.recipes.metadata import CommandSpec
from bot.core.widgets.recipes.registry import RecipeRegistry, collect_recipes, recipe
...
async def sync_join_guide(
    ...
    from bot.core.channels.resolve import resolve_join_the_network_channel
...
async def provision_client_from_request(
    ...
    *,
    ...
    from bot.core.widgets.recipes.onboarding.service import _ProvisionOutcome
