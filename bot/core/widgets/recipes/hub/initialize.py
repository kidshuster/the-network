...
from bot.core.channels.layout import (
    ApplyMode,
    LayoutContext,
    apply_layout,
    compile_client,
    ...
    *,
    ...
    try:
        ...
        if bot is not None and context is not None and view_registry is not None:
            from bot.core.channels.stickies.join import sync_hub_join_sticky
            from bot.core.channels.stickies.rules import sync_rules_sticky
            ...
            from bot.core.channels.resolve import resolve_network_admin_channel
