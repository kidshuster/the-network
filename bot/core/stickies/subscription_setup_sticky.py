...
from bot.core.stickies.subscription_setup import SubscriptionSetupState, resolve_setup_state
from bot.core.stickies.sync import (
...
async def sync_subscription_setup(
    ...
    *,
    ...
    from bot.core.clients.profile_sync import (
