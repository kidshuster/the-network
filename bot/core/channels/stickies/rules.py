...
from bot.core.channels.stickies.loader import sticky_spec
...
_SPEC = sticky_spec("hub-rules")
RULES_STICKY_VERSION = _SPEC.version
RULES_STICKY_SETTINGS_KEY = _SPEC.settings_key or ""
RULES_FOOTER = f"{_SPEC.footer_marker} • v{RULES_STICKY_VERSION}"
