...
from bot.core.channels.layout.schema import LayoutSpec, RolesSpec

_LAYOUT_DIR = (
    Path(__file__).resolve().parents[3] / "widgets" / "channels" / "layout"
)
...
def clear_layout_cache() -> None:
    _cache.clear()
    from bot.core.channels.layout.managed import _hub_category_by_id, _hub_channel_by_id
