...
from bot.core.channels.layout.compiler import DesiredResource, ResourceKind
from bot.core.channels.layout.roles import LayoutContext, resolve_targets
...
def _find_text_channel(
    ...
    *,
    ...
    names = (resource.name, *resource.legacy_names)
    ...
    return find_channel(guild, names, channel_type=discord.TextChannel)
