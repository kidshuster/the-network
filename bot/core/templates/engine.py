...
_FEATURES_DIR = _BOT_DIR / "features"
_TEMPLATES_DIR = _FEATURES_DIR / "widgets" / "templates"
_EMBEDS_DIR = _TEMPLATES_DIR / "embeds"
_POPUPS_DIR = _TEMPLATES_DIR / "popups"
_MODALS_DIR = _TEMPLATES_DIR / "modals"
_CHANNEL_TEMPLATES_DIR = _FEATURES_DIR / "channels" / "templates"
...
def _find_template_path(name: str) -> Path:
    for directory in (_EMBEDS_DIR, _POPUPS_DIR, _MODALS_DIR, _CHANNEL_TEMPLATES_DIR):
