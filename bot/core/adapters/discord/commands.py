...
from bot.core.adapters.discord.errors import respond_to_error
from bot.core.adapters.discord.responses import defer_ephemeral
from bot.core.widgets.presenters import present_result
from bot.core.widgets.recipes.metadata import RecipeSpec
...
def _callback(bot: NetworkRelayBot, spec: RecipeSpec) -> Callable[..., Any]:
    ...
    async def invoke(interaction: discord.Interaction) -> None:
        ...
        try:
            ...
            await present_result(command.presenter, response, value)
