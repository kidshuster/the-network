...
from bot.widgets.views.join_views import JoinNetworkModal, ModeratorReviewView
...
async def test_join_modal_renders_failure_embed_on_service_error(
    ...
    monkeypatch.setattr(
        "bot.widgets.recipes.onboarding.service.ServerRequestService.submit_request",
...
async def test_moderator_review_renders_failure_embed_on_service_error(
    ...
    monkeypatch.setattr(
        "bot.widgets.recipes.onboarding.service.ServerRequestService.deny_request",
